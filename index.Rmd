...
I am also an enthusiastic adherent of reproducible analysis and coding, especially with [`r icon_style(fontawesome$brands$"r-project", scale = 1.3, fill = "#5F85A7")`](https://www.r-project.org/)! Please see my blog for more stories about this topic.
