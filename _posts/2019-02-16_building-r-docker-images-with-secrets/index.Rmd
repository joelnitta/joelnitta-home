...
citation_url: https://joelnitta.com/building-r-docker-images-with-secrets 
repository_url: https://github.com/joelnitta/joelnitta.com
output:
...
image_read("https://upload.wikimedia.org/wikipedia/commons/d/d6/UKUSA_top_secret.jpg") %>%
  ...
  image_write(path = here::here("_posts/2019-02-16_building-r-docker-images-with-secrets/featured.png"), format = "png")
```

<!--------------- post ----------------->

```{r feature, layout = "l-body-outset"}
#| echo = FALSE,
#| fig.cap = "Image in the public domain on [wikimedia](https://commons.wikimedia.org/wiki/File:UKUSA_top_secret.jpg)." 
