...
We will use this for a quick demo.
...
For more information about `canaper`, please see the [GitHub repo](https://github.com/ropensci/canaper) and [package website](https://docs.ropensci.org/canaper/).
