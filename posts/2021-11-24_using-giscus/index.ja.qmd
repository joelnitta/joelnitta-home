...
Since writing this blogpost, a new publishing system called [Quarto](https://quarto.org/) is now available that [supports giscus natively](https://quarto.org/docs/output-formats/html-basics.html#commenting). If you are setting up a new blog or website, you may want to consider using Quarto instead of Distill^[I have converted my website to Quarto.].
It will save you the trouble of setting up everything like I describe below.
...
![Image by [Adam Solomon](https://unsplash.com/@solomac) on [unsplash](https://unsplash.com/photos/WHUDOzd5IYU)](img/adam-solomon-WHUDOzd5IYU-unsplash.jpg){#fig-featured}
...
![[giscus](https://giscus.app/) configuration menu.](img/giscus-config.png){#fig-giscus-config}

![[giscus](https://giscus.app/) HTML block. Once you fill in the fields in the configuration menu, the parts starting with `[ENTER ...]` will get automatically populated.](img/giscus-enable.png){#fig-giscus-html}
...
If you compare the above code with the HTML block in the giscus app (@fig-giscus-html), you should be able to see how the `script.setAttribute` lines above map to the key-value pairs in the HTML block in the giscus app. All we have to do is copy the contents of the HTML block over to this `giscus.html` file. You can [see what my `giscus.html` file looks like here](https://github.com/joelnitta/joelnitta-home/blob/047152c2d1c6cfdeee438b6e23453d4330ece6ef/giscus.html).
...
- [Source code](https://github.com/joelnitta/joelnitta-home/tree/main/posts/2021-11-24_using-giscus/index.ja.qmd)