...
```{r}
#| label: fig-plot-contmap-default-show
#| eval: false
#| echo: true
#| fig.cap: Default rainbow color scheme. Pretty, but confusing.
...
```{r}
#| label: fig-plot-contmap-default-hide
#| eval: true
#| echo: false
#| fig.cap: Default rainbow color scheme. Pretty, but confusing.

tempfile <- tempfile()
download.file("http://www.phytools.org/eqg2015/data/anole.tre", tempfile)
anole.tree <- read.tree(tempfile)
unlink(tempfile)
...
```{r}
#| label: fig-colorRampPalette
#| fig-cap: A red-to-yellow color ramp.
...
```{r}
#| label: colorRampPalette-viridis
...
```{r}
#| label: fig-phytools-viridis
#| fig.cap: Viridis colors. Better.
...
```{r}
#| label: fig-phytools-scico
#| fig.cap: Scico colors. My personal favorite.
...
```{r}
#| label: fig-plot-contmap-ggtree
#| fig.cap: Scico colors with ggtree.
...
- [Source code](https://github.com/joelnitta/joelnitta-home/tree/main/posts/2021-06-02_color-scheme-anc-states/index.qmd)
